  ...
  return [
    {
      ...
      items: [
        ...
        { href: '/approvals', label: d.ui.approval.queueTitle, resource: 'documents' },
        { href: '/notifications', label: d.ui.notify.title, resource: 'documents' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/sales/sales-orders', label: d.nav.salesOrders, resource: 'documents' },
        { href: '/sales/delivery-orders', label: d.nav.deliveryOrders, resource: 'documents' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/inventory/lots', label: d.ui.lot.title, resource: 'products.inventory' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/accounting/year-end', label: d.ui.yearEnd.title, resource: 'period' },
      ],
    },
    {
      id: 'reports', label: d.nav.reports, icon: 'BarChart3',
      items: [
        { href: '/reports/kpi', label: d.ui.kpi.title, resource: 'report' },
        { href: '/reports/trial-balance', label: d.nav.trialBalance, resource: 'report' },
        { href: '/reports/compare', label: d.ui.compare.title, resource: 'report' },
        ...
        { href: '/reports/cash-flow', label: d.ui.cashFlow.title, resource: 'report' },
        ...
        { href: '/reports/by-department', label: d.ui.dimension.plTitle, resource: 'report' },
        { href: '/reports/credit-watch', label: d.ui.credit.watchTitle, resource: 'report' },
        { href: '/reports/by-sales-rep', label: d.ui.salesRep.reportTitle, resource: 'report' },
        { href: '/reports/backorders', label: d.ui.delivery.backorderTitle, resource: 'report' },
        { href: '/reports/fx-rates', label: d.ui.fxTrend.title, resource: 'documents' },
      ],
    },
    {
      id: 'tax', label: d.nav.tax, icon: 'Receipt',
      items: [
        { href: '/tax/vat/sales', label: d.nav.vatSales, resource: 'tax' },
        { href: '/tax/vat/purchase', label: d.nav.vatPurchase, resource: 'tax' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/settings/approval', label: d.ui.approval.title, resource: 'settings.roles' },
        ...
        { href: '/settings/dimensions', label: d.ui.dimension.title, resource: 'settings.dimensions' },
        { href: '/settings/sales-reps', label: d.ui.salesRep.title, resource: 'contacts' },
